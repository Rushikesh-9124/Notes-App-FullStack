...
export type ExtendsElement = import("@eslint/config-helpers/dist/esm/types").ExtendsElement;
export type SimpleExtendsElement = import("@eslint/config-helpers/dist/esm/types").SimpleExtendsElement;
export type ConfigWithExtends = import("@eslint/config-helpers/dist/esm/types").ConfigWithExtends;
export type InfiniteConfigArray = import("@eslint/config-helpers/dist/esm/types").InfiniteArray<Config>;
export type ConfigWithExtendsArray = import("@eslint/config-helpers/dist/esm/types").ConfigWithExtendsArray;
/**
